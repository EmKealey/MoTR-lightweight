...
<template>
  <Experiment title="Mouse tracking for Reading" translate="no">
    ...
    <Screen :title="'welcome'" class="instructions" :validations="{
        ...
        <br><br>
          <b>What is the study about?</b> Emma Kealey needs to practice setting up MoTR studies online. This is a demo experiment.
        <br><br>
        ...
        <br><br>
          <b>Contact:</b> Emma Kealey [kealey@usc.edu] Department of Linguistics, University of Southern California <br>
        </p>
